...
Call_001_4FB2::
    ldh a, [hFrameCounter]                        ; $4FB2: $F0 $AC
    and $01                                       ; $4FB4: $E6 $01
    ret nz                                        ; $4FB6: $C0
...
Call_01_4FEC::
    ldh a, [hJoyHeld]                                  ; $4FEC: $F0 $80
    bit PADB_UP, a                                      ; $4FEE: $CB $77
    jr nz, .jr_001_5034                            ; $4FF0: $20 $42

    bit PADB_DOWN, a                                      ; $4FF2: $CB $7F
    jr nz, .jr_001_5022                            ; $4FF4: $20 $2C

.jr_001_4FF6
    ldh a, [hJoyHeld]                                  ; $4FF6: $F0 $80
    bit PADB_RIGHT, a                                      ; $4FF8: $CB $67
    jr nz, .jr_001_5014                            ; $4FFA: $20 $18

    bit PADB_LEFT, a                                      ; $4FFC: $CB $6F
    ret z                                         ; $4FFE: $C8
...
.jr_001_5052
    ld a, [hli]                                   ; $5052: $2A
    add b                                         ; $5053: $80
    ldh [$FFAD], a                                  ; $5054: $E0 $AD
    ldh a, [hScrollX]                                  ; $5056: $F0 $A4
    ld b, [hl]                                    ; $5058: $46
    add b                                         ; $5059: $80
    add $02                                       ; $505A: $C6 $02
    ldh [$FFAE], a                                  ; $505C: $E0 $AE
    call LookupTile                               ; $505E: $CD $53 $01
    cp $60                                        ; $5061: $FE $60
    jr nc, .jr_001_5071                            ; $5063: $30 $0C

    ldh a, [$FFAE]                                  ; $5065: $F0 $AE
    add $FA                                       ; $5067: $C6 $FA
    ldh [$FFAE], a                                  ; $5069: $E0 $AE
...
Call_001_5089:
    ...
    ld a, [hli]                                   ; $508C: $2A
    add $0A                                       ; $508D: $C6 $0A
    ldh [$FFAD], a                                  ; $508F: $E0 $AD
    ldh a, [hScrollX]                                  ; $5091: $F0 $A4
    ld b, a                                       ; $5093: $47
    ld a, [hl]                                    ; $5094: $7E
    add b                                         ; $5095: $80
    add $FE                                       ; $5096: $C6 $FE
    ldh [$FFAE], a                                  ; $5098: $E0 $AE
    call LookupTile                               ; $509A: $CD $53 $01
    cp $60                                        ; $509D: $FE $60
    jr nc, .jr_001_50B4                            ; $509F: $30 $13

    ldh a, [$FFAE]                                  ; $50A1: $F0 $AE
    add $04                                       ; $50A3: $C6 $04
    ldh [$FFAE], a                                  ; $50A5: $E0 $AE
...
.jr_001_50D8
    ...
    ld a, [hli]                                   ; $50DB: $2A
    add d                                         ; $50DC: $82
    ldh [$FFAD], a                                  ; $50DD: $E0 $AD
    ld b, [hl]                                    ; $50DF: $46
    ld a, c                                       ; $50E0: $79
    add b                                         ; $50E1: $80
    ld b, a                                       ; $50E2: $47
    ldh a, [hScrollX]                                  ; $50E3: $F0 $A4
    add b                                         ; $50E5: $80
    ldh [$FFAE], a                                  ; $50E6: $E0 $AE
    push de                                       ; $50E8: $D5
...
.jr_001_512C
    ...
    inc a                                         ; $5132: $3C
    ld [de], a                                    ; $5133: $12
    ldh [$FFA1], a                                  ; $5134: $E0 $A1
    ldh [$FFC3], a                                  ; $5136: $E0 $C3
    cp $A9                                        ; $5138: $FE $A9
...
.jr_001_5143
    ...
    dec e                                         ; $5146: $1D
    ld a, [de]                                    ; $5147: $1A
    ldh [$FFC2], a                                  ; $5148: $E0 $C2
    add $06                                       ; $514A: $C6 $06
    ldh [$FFAD], a                                  ; $514C: $E0 $AD
    pop af                                        ; $514E: $F1
...
.jr_001_5168
    xor a                                         ; $5168: $AF
    ldh [hSuperStatus], a                                  ; $5169: $E0 $99
    ldh [hSuperballMario], a                                  ; $516B: $E0 $B5
    inc a                                         ; $516D: $3C
    ldh [hGameState], a                                  ; $516E: $E0 $B3
    inc a                                         ; $5170: $3C
    ld [wPlaySong], a                             ; $5171: $EA $E8 $DF
    ld a, $90                                     ; $5174: $3E $90
    ldh [hTimer], a                                  ; $5176: $E0 $A6
    ret  
